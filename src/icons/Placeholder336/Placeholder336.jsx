...
export const Placeholder336 = ({ color = "#6941C6", className }) => {
  return (
    <svg
      className={`placeholder-336 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_1_4392)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_1_4392">
