...
export const Size40_5 = ({ className }) => {
  return (
    <svg
      className={`size-40-5 ${className}`}
      fill="none"
      height="40"
      viewBox="0 0 40 40"
      width="40"
