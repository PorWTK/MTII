...
export const SocialIcon118 = ({ className }) => {
  return (
    <svg
      className={`social-icon-118 ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_1_18428)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_1_18428">
