...
export const HelpCircle61 = ({ className }) => {
  return (
    <svg
      className={`help-circle-61 ${className}`}
      fill="none"
      height="16"
      viewBox="0 0 16 16"
      width="16"
    ...
    >
      <g className="g" clipPath="url(#clip0_115_78691)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_115_78691">
