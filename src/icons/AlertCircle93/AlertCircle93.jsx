...
export const AlertCircle93 = ({ color = "white", className }) => {
  return (
    <svg
      className={`alert-circle-93 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
    ...
    >
      <g className="g" clipPath="url(#clip0_1_16646)">
        <path
          className="path"
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_1_16646">
