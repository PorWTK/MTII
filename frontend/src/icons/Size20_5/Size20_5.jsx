...
export const Size20_5 = ({ className }) => {
  return (
    <svg
      className={`size-20-5 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 20 20"
      width="20"
