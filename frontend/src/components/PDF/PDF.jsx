...
//                 <div className="name">@Pinnnnn</div>

//                 <input
//                 className="email"
//                 placeholder="pinpinpin@gmail.com"
//                 type="email"
//                 />

//                 <div className="phone">+66 678678678</div>
//             </div>

//             <div className="div">
//                 <p className="address">
//                 123 หม ดา ซอย 2 เขต สามสาม แขวง ประประ จงหวด กรงเทพมหานคร 12345
//                 </p>

//                 <div className="taxid">
//                 <div className="text-wrapper">TAX ID:</div>

//                 <div className="text-wrapper">00XXXXX1234X0XX</div>
//                 </div>
//             </div>
//         </div>
...
//                 <div className="text-wrapper-4">QT12345678</div>
//             </div>

//             <div className="issue-date">
//                 <div className="text-wrapper-3">Issue date</div>

//                 <div className="text-wrapper-4">1 January 2024</div>
//             </div>
...
//                 <div className="text-wrapper-6">1 January 2024</div>
//             </div>
...
//                 <div className="agency-name">บรษท เอเจนซ</div>

//                 <p className="text-wrapper-7">
//                     123 หม ดา ซอย 2 เขต สามสาม แขวง ประประ จงหวด กรงเทพมหานคร 12345
//                 </p>

//                 <div className="text-wrapper-7">+66 345345345</div>

//                 <div className="taxid-2">
//                     <div className="text-wrapper-8">TAX ID:</div>

//                     <div className="text-wrapper-8">00XXXXX1234X0XX</div>
//                 </div>
//                 </div>
//             </div>
...
//             <div className="lists">
//                 <div className="list">
//                 <div className="description-2">Item Name</div>

//                 <div className="qty">1</div>

//                 <div className="text-wrapper-10">3,000.00</div>
...
//                 <div className="text-wrapper-12">4,500.00</div>
//             </div>
...
//                 หก ณ ทจาย (12345+1%)=1,0000
//                 <br />
//                 ยอดเงนเขาบญช (11,000-1,0000)=10,000 บาท
//                 <br />
//                 กรณาโอนเงนเขา บญช fwertyuikolkmnbvcxdfgh
//                 </p>
//             </div>
...
//                 <div className="text">
//                 <div className="text-wrapper-14">Bill issuer (ผวางบล)</div>

//                 <div className="text-wrapper-15">1 January 2024</div>
//                 </div>
//             </div>
...
//                 <div className="text">
//                 <div className="text-wrapper-14">Payment receiver (ผรบเงน)</div>
//                 </div>
//             </div>
...
//                 <div className="text">
//                 <div className="text-wrapper-14">Bill receiver (ผรบบล)</div>
//                 </div>
//             </div>
//             </div>
...
//                     เงอนไขและรายละเอยดเพมเตมตามแชทไลน Line:
//                     </div>

//                     <div className="text-wrapper-17">somsom</div>
//                 </div>

//                 <p className="paymentmethod">Credit Term 30 days after posting</p>
//             </div>
//         </div>
    ...
    <div className="PDF-format">
      <div className="main">
        ...
        <div className="main-bill">
          ...
          <div className="ref">
            <div className="text-wrapper-3">Reference</div>
            <div className="text-wrapper-4">{data.transaction_reference_number}</div>
          </div>
        </div>
